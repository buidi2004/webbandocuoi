...
if not exist "backend\ivie.db" (
    ...
    backend\.venv\Scripts\python.exe backend\khoi_tao_du_lieu.py
)
start "Backend API" cmd /k "cd backend && .\.venv\Scripts\python.exe -m uvicorn ung_dung.chinh:ung_dung --reload --host 127.0.0.1 --port 8000"
